...
public class InternalCcsEclipseParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_HEXINT", "RULE_NUMBER", "RULE_STRING", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'@context'", "'('", "')'", "';'", "'>'", "','", "':'", "'{'", "'}'", "'='", "'true'", "'false'", "'@constrain'", "'.'", "'/'", "'@import'"
    };
    ...
    public final EObject ruleRuleSet() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( (LA2_0==RULE_ID||LA2_0==RULE_STRING||LA2_0==14||LA2_0==25||LA2_0==28) ) {
                    alt2=1;
                }
    ...
    public final AntlrDatatypeRuleToken ruleRule() throws RecognitionException {
        ...
        try {
            ...
            case RULE_ID:
                ...
                else if ( (LA9_3==RULE_ID||LA9_3==RULE_STRING||LA9_3==14||(LA9_3>=17 && LA9_3<=20)||(LA9_3>=26 && LA9_3<=27)) ) {
                    alt9=4;
                }
                else {
                    NoViableAltException nvae =
            ...
            switch (alt13) {
                ...
                case 2 :
                    ...
                    do {
                        ...
                        if ( (LA12_0==RULE_ID||LA12_0==RULE_STRING||LA12_0==14||LA12_0==25||LA12_0==28) ) {
                            alt12=1;
                        }
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:574:1: entryRuleProperty returns [String current=null] : iv_ruleProperty= ruleProperty EOF ;
    public final String entryRuleProperty() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:575:2: (iv_ruleProperty= ruleProperty EOF )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:576:2: iv_ruleProperty= ruleProperty EOF
            {
             newCompositeNode(grammarAccess.getPropertyRule()); 
            pushFollow(FOLLOW_ruleProperty_in_entryRuleProperty1519);
            iv_ruleProperty=ruleProperty();

            state._fsp--;

             current =iv_ruleProperty.getText(); 
            match(input,EOF,FOLLOW_EOF_in_entryRuleProperty1530); 
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:583:1: ruleProperty returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (this_ID_0= RULE_ID kw= '=' this_Value_2= ruleValue ) ;
    public final AntlrDatatypeRuleToken ruleProperty() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:586:28: ( (this_ID_0= RULE_ID kw= '=' this_Value_2= ruleValue ) )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:587:1: (this_ID_0= RULE_ID kw= '=' this_Value_2= ruleValue )
            {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:587:1: (this_ID_0= RULE_ID kw= '=' this_Value_2= ruleValue )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:587:6: this_ID_0= RULE_ID kw= '=' this_Value_2= ruleValue
            {
            this_ID_0=(Token)match(input,RULE_ID,FOLLOW_RULE_ID_in_ruleProperty1570); 
            ...
            kw=(Token)match(input,22,FOLLOW_22_in_ruleProperty1588); 
            ...
            pushFollow(FOLLOW_ruleValue_in_ruleProperty1610);
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:619:1: entryRulebool returns [String current=null] : iv_rulebool= rulebool EOF ;
    public final String entryRulebool() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:620:2: (iv_rulebool= rulebool EOF )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:621:2: iv_rulebool= rulebool EOF
            {
             newCompositeNode(grammarAccess.getBoolRule()); 
            pushFollow(FOLLOW_rulebool_in_entryRulebool1656);
            iv_rulebool=rulebool();

            state._fsp--;

             current =iv_rulebool.getText(); 
            match(input,EOF,FOLLOW_EOF_in_entryRulebool1667); 
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:628:1: rulebool returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (kw= 'true' | kw= 'false' ) ;
    public final AntlrDatatypeRuleToken rulebool() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:631:28: ( (kw= 'true' | kw= 'false' ) )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:632:1: (kw= 'true' | kw= 'false' )
            {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:632:1: (kw= 'true' | kw= 'false' )
            int alt14=2;
            ...
            switch (alt14) {
                case 1 :
                    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:633:2: kw= 'true'
                    {
                    kw=(Token)match(input,23,FOLLOW_23_in_rulebool1705); 
                    ...
                    break;
                case 2 :
                    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:640:2: kw= 'false'
                    {
                    kw=(Token)match(input,24,FOLLOW_24_in_rulebool1724); 
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:653:1: entryRuleValue returns [String current=null] : iv_ruleValue= ruleValue EOF ;
    public final String entryRuleValue() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:654:2: (iv_ruleValue= ruleValue EOF )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:655:2: iv_ruleValue= ruleValue EOF
            {
             newCompositeNode(grammarAccess.getValueRule()); 
            pushFollow(FOLLOW_ruleValue_in_entryRuleValue1765);
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:662:1: ruleValue returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (this_HEXINT_0= RULE_HEXINT | this_NUMBER_1= RULE_NUMBER | this_STRING_2= RULE_STRING | this_bool_3= rulebool ) ;
    public final AntlrDatatypeRuleToken ruleValue() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:665:28: ( (this_HEXINT_0= RULE_HEXINT | this_NUMBER_1= RULE_NUMBER | this_STRING_2= RULE_STRING | this_bool_3= rulebool ) )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:666:1: (this_HEXINT_0= RULE_HEXINT | this_NUMBER_1= RULE_NUMBER | this_STRING_2= RULE_STRING | this_bool_3= rulebool )
            {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:666:1: (this_HEXINT_0= RULE_HEXINT | this_NUMBER_1= RULE_NUMBER | this_STRING_2= RULE_STRING | this_bool_3= rulebool )
            int alt15=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt15) {
                case 1 :
                    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:666:6: this_HEXINT_0= RULE_HEXINT
                    {
                    this_HEXINT_0=(Token)match(input,RULE_HEXINT,FOLLOW_RULE_HEXINT_in_ruleValue1816); 
                    ...
                    break;
                case 2 :
                    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:674:10: this_NUMBER_1= RULE_NUMBER
                    {
                    this_NUMBER_1=(Token)match(input,RULE_NUMBER,FOLLOW_RULE_NUMBER_in_ruleValue1842); 
                    ...
                    break;
                case 3 :
                    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:682:10: this_STRING_2= RULE_STRING
                    {
                    this_STRING_2=(Token)match(input,RULE_STRING,FOLLOW_RULE_STRING_in_ruleValue1868); 
                    ...
                    break;
                case 4 :
                    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:691:5: this_bool_3= rulebool
                    {
                     
                            newCompositeNode(grammarAccess.getValueAccess().getBoolParserRuleCall_3()); 
                        
                    pushFollow(FOLLOW_rulebool_in_ruleValue1901);
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:709:1: entryRuleConstraint returns [String current=null] : iv_ruleConstraint= ruleConstraint EOF ;
    public final String entryRuleConstraint() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:710:2: (iv_ruleConstraint= ruleConstraint EOF )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:711:2: iv_ruleConstraint= ruleConstraint EOF
            {
             newCompositeNode(grammarAccess.getConstraintRule()); 
            pushFollow(FOLLOW_ruleConstraint_in_entryRuleConstraint1947);
            iv_ruleConstraint=ruleConstraint();

            state._fsp--;

             current =iv_ruleConstraint.getText(); 
            match(input,EOF,FOLLOW_EOF_in_entryRuleConstraint1958); 
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:718:1: ruleConstraint returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (kw= '@constrain' this_SingleStep_1= ruleSingleStep ) ;
    public final AntlrDatatypeRuleToken ruleConstraint() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:721:28: ( (kw= '@constrain' this_SingleStep_1= ruleSingleStep ) )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:722:1: (kw= '@constrain' this_SingleStep_1= ruleSingleStep )
            {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:722:1: (kw= '@constrain' this_SingleStep_1= ruleSingleStep )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:723:2: kw= '@constrain' this_SingleStep_1= ruleSingleStep
            {
            kw=(Token)match(input,25,FOLLOW_25_in_ruleConstraint1996); 
            ...
            pushFollow(FOLLOW_ruleSingleStep_in_ruleConstraint2018);
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:747:1: entryRuleSingleStep returns [String current=null] : iv_ruleSingleStep= ruleSingleStep EOF ;
    public final String entryRuleSingleStep() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:748:2: (iv_ruleSingleStep= ruleSingleStep EOF )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:749:2: iv_ruleSingleStep= ruleSingleStep EOF
            {
             newCompositeNode(grammarAccess.getSingleStepRule()); 
            pushFollow(FOLLOW_ruleSingleStep_in_entryRuleSingleStep2064);
            iv_ruleSingleStep=ruleSingleStep();

            state._fsp--;

             current =iv_ruleSingleStep.getText(); 
            match(input,EOF,FOLLOW_EOF_in_entryRuleSingleStep2075); 
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:756:1: ruleSingleStep returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (this_Ident_0= ruleIdent (this_Vals_1= ruleVals )? (this_StepSuffix_2= ruleStepSuffix )? ) ;
    public final AntlrDatatypeRuleToken ruleSingleStep() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:759:28: ( (this_Ident_0= ruleIdent (this_Vals_1= ruleVals )? (this_StepSuffix_2= ruleStepSuffix )? ) )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:760:1: (this_Ident_0= ruleIdent (this_Vals_1= ruleVals )? (this_StepSuffix_2= ruleStepSuffix )? )
            {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:760:1: (this_Ident_0= ruleIdent (this_Vals_1= ruleVals )? (this_StepSuffix_2= ruleStepSuffix )? )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:761:5: this_Ident_0= ruleIdent (this_Vals_1= ruleVals )? (this_StepSuffix_2= ruleStepSuffix )?
            {
             
                    newCompositeNode(grammarAccess.getSingleStepAccess().getIdentParserRuleCall_0()); 
                
            pushFollow(FOLLOW_ruleIdent_in_ruleSingleStep2122);
            ...
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:771:1: (this_Vals_1= ruleVals )?
            int alt16=2;
            ...
            switch (alt16) {
                case 1 :
                    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:772:5: this_Vals_1= ruleVals
                    {
                     
                            newCompositeNode(grammarAccess.getSingleStepAccess().getValsParserRuleCall_1()); 
                        
                    pushFollow(FOLLOW_ruleVals_in_ruleSingleStep2150);
            ...
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:782:3: (this_StepSuffix_2= ruleStepSuffix )?
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:783:5: this_StepSuffix_2= ruleStepSuffix
                    {
                     
                            newCompositeNode(grammarAccess.getSingleStepAccess().getStepSuffixParserRuleCall_2()); 
                        
                    pushFollow(FOLLOW_ruleStepSuffix_in_ruleSingleStep2180);
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:801:1: entryRuleIdent returns [String current=null] : iv_ruleIdent= ruleIdent EOF ;
    public final String entryRuleIdent() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:802:2: (iv_ruleIdent= ruleIdent EOF )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:803:2: iv_ruleIdent= ruleIdent EOF
            {
             newCompositeNode(grammarAccess.getIdentRule()); 
            pushFollow(FOLLOW_ruleIdent_in_entryRuleIdent2228);
            iv_ruleIdent=ruleIdent();

            state._fsp--;

             current =iv_ruleIdent.getText(); 
            match(input,EOF,FOLLOW_EOF_in_entryRuleIdent2239); 
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:810:1: ruleIdent returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (this_ID_0= RULE_ID | this_STRING_1= RULE_STRING ) ;
    public final AntlrDatatypeRuleToken ruleIdent() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:813:28: ( (this_ID_0= RULE_ID | this_STRING_1= RULE_STRING ) )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:814:1: (this_ID_0= RULE_ID | this_STRING_1= RULE_STRING )
            {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:814:1: (this_ID_0= RULE_ID | this_STRING_1= RULE_STRING )
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:814:6: this_ID_0= RULE_ID
                    {
                    this_ID_0=(Token)match(input,RULE_ID,FOLLOW_RULE_ID_in_ruleIdent2279); 
                    ...
                    break;
                case 2 :
                    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:822:10: this_STRING_1= RULE_STRING
                    {
                    this_STRING_1=(Token)match(input,RULE_STRING,FOLLOW_RULE_STRING_in_ruleIdent2305); 
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:837:1: entryRuleVals returns [String current=null] : iv_ruleVals= ruleVals EOF ;
    public final String entryRuleVals() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:838:2: (iv_ruleVals= ruleVals EOF )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:839:2: iv_ruleVals= ruleVals EOF
            {
             newCompositeNode(grammarAccess.getValsRule()); 
            pushFollow(FOLLOW_ruleVals_in_entryRuleVals2351);
            iv_ruleVals=ruleVals();

            state._fsp--;

             current =iv_ruleVals.getText(); 
            match(input,EOF,FOLLOW_EOF_in_entryRuleVals2362); 
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:846:1: ruleVals returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (kw= '.' this_Ident_1= ruleIdent (this_Vals_2= ruleVals )* ) ;
    public final AntlrDatatypeRuleToken ruleVals() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:849:28: ( (kw= '.' this_Ident_1= ruleIdent (this_Vals_2= ruleVals )* ) )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:850:1: (kw= '.' this_Ident_1= ruleIdent (this_Vals_2= ruleVals )* )
            {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:850:1: (kw= '.' this_Ident_1= ruleIdent (this_Vals_2= ruleVals )* )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:851:2: kw= '.' this_Ident_1= ruleIdent (this_Vals_2= ruleVals )*
            {
            kw=(Token)match(input,26,FOLLOW_26_in_ruleVals2400); 
            ...
            pushFollow(FOLLOW_ruleIdent_in_ruleVals2422);
            ...
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:867:1: (this_Vals_2= ruleVals )*
            loop19:
            do {
                int alt19=2;
                ...
                switch (alt19) {
            	case 1 :
            	    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:868:5: this_Vals_2= ruleVals
            	    {
            	     
            	            newCompositeNode(grammarAccess.getValsAccess().getValsParserRuleCall_2()); 
            	        
            	    pushFollow(FOLLOW_ruleVals_in_ruleVals2450);
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:886:1: entryRuleStepSuffix returns [String current=null] : iv_ruleStepSuffix= ruleStepSuffix EOF ;
    public final String entryRuleStepSuffix() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:887:2: (iv_ruleStepSuffix= ruleStepSuffix EOF )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:888:2: iv_ruleStepSuffix= ruleStepSuffix EOF
            {
             newCompositeNode(grammarAccess.getStepSuffixRule()); 
            pushFollow(FOLLOW_ruleStepSuffix_in_entryRuleStepSuffix2498);
            iv_ruleStepSuffix=ruleStepSuffix();

            state._fsp--;

             current =iv_ruleStepSuffix.getText(); 
            match(input,EOF,FOLLOW_EOF_in_entryRuleStepSuffix2509); 
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:895:1: ruleStepSuffix returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (kw= '/' this_SingleStep_1= ruleSingleStep ) ;
    public final AntlrDatatypeRuleToken ruleStepSuffix() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:898:28: ( (kw= '/' this_SingleStep_1= ruleSingleStep ) )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:899:1: (kw= '/' this_SingleStep_1= ruleSingleStep )
            {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:899:1: (kw= '/' this_SingleStep_1= ruleSingleStep )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:900:2: kw= '/' this_SingleStep_1= ruleSingleStep
            {
            kw=(Token)match(input,27,FOLLOW_27_in_ruleStepSuffix2547); 
            ...
            pushFollow(FOLLOW_ruleSingleStep_in_ruleStepSuffix2569);
            this_SingleStep_1=ruleSingleStep();
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:924:1: entryRuleImport returns [String current=null] : iv_ruleImport= ruleImport EOF ;
    public final String entryRuleImport() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:925:2: (iv_ruleImport= ruleImport EOF )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:926:2: iv_ruleImport= ruleImport EOF
            {
             newCompositeNode(grammarAccess.getImportRule()); 
            pushFollow(FOLLOW_ruleImport_in_entryRuleImport2615);
            iv_ruleImport=ruleImport();

            state._fsp--;

             current =iv_ruleImport.getText(); 
            match(input,EOF,FOLLOW_EOF_in_entryRuleImport2626); 
    ...
    // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:933:1: ruleImport returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (kw= '@import' this_STRING_1= RULE_STRING ) ;
    public final AntlrDatatypeRuleToken ruleImport() throws RecognitionException {
        ...
        try {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:936:28: ( (kw= '@import' this_STRING_1= RULE_STRING ) )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:937:1: (kw= '@import' this_STRING_1= RULE_STRING )
            {
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:937:1: (kw= '@import' this_STRING_1= RULE_STRING )
            // ../net.immute.ccs.CcsEclipse/src-gen/net/immute/ccs/parser/antlr/internal/InternalCcsEclipse.g:938:2: kw= '@import' this_STRING_1= RULE_STRING
            {
            kw=(Token)match(input,28,FOLLOW_28_in_ruleImport2664); 

                    current.merge(kw);
                    newLeafNode(kw, grammarAccess.getImportAccess().getImportKeyword_0()); 
                
            this_STRING_1=(Token)match(input,RULE_STRING,FOLLOW_RULE_STRING_in_ruleImport2679); 
    ...
    public static final BitSet FOLLOW_ruleContext_in_ruleRuleSet131 = new BitSet(new long[]{0x0000000012004092L});
    public static final BitSet FOLLOW_ruleRule_in_ruleRuleSet153 = new BitSet(new long[]{0x0000000012004092L});
    ...
    public static final BitSet FOLLOW_14_in_ruleContext249 = new BitSet(new long[]{0x0000000012004090L});
    ...
    public static final BitSet FOLLOW_18_in_ruleSum531 = new BitSet(new long[]{0x0000000012004090L});
    ...
    public static final BitSet FOLLOW_ruleTerm_in_ruleProduct659 = new BitSet(new long[]{0x0000000012004092L});
    ...
    public static final BitSet FOLLOW_17_in_ruleTerm783 = new BitSet(new long[]{0x0000000012004090L});
    ...
    public static final BitSet FOLLOW_14_in_ruleStep936 = new BitSet(new long[]{0x0000000012004090L});
    ...
    public static final BitSet FOLLOW_19_in_ruleNested1317 = new BitSet(new long[]{0x0000000012000010L});
    ...
    public static final BitSet FOLLOW_20_in_ruleNested1433 = new BitSet(new long[]{0x0000000012204090L});
    public static final BitSet FOLLOW_ruleRule_in_ruleNested1456 = new BitSet(new long[]{0x0000000012204090L});
    public static final BitSet FOLLOW_21_in_ruleNested1476 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleProperty_in_entryRuleProperty1519 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleProperty1530 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleProperty1570 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_22_in_ruleProperty1588 = new BitSet(new long[]{0x00000000018000E0L});
    public static final BitSet FOLLOW_ruleValue_in_ruleProperty1610 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_rulebool_in_entryRulebool1656 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRulebool1667 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_23_in_rulebool1705 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_24_in_rulebool1724 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleValue_in_entryRuleValue1765 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleValue1776 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_RULE_HEXINT_in_ruleValue1816 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_RULE_NUMBER_in_ruleValue1842 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_RULE_STRING_in_ruleValue1868 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_rulebool_in_ruleValue1901 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleConstraint_in_entryRuleConstraint1947 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleConstraint1958 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_25_in_ruleConstraint1996 = new BitSet(new long[]{0x0000000000000090L});
    public static final BitSet FOLLOW_ruleSingleStep_in_ruleConstraint2018 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleSingleStep_in_entryRuleSingleStep2064 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleSingleStep2075 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleIdent_in_ruleSingleStep2122 = new BitSet(new long[]{0x000000000C000002L});
    public static final BitSet FOLLOW_ruleVals_in_ruleSingleStep2150 = new BitSet(new long[]{0x0000000008000002L});
    public static final BitSet FOLLOW_ruleStepSuffix_in_ruleSingleStep2180 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleIdent_in_entryRuleIdent2228 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleIdent2239 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleIdent2279 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_RULE_STRING_in_ruleIdent2305 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleVals_in_entryRuleVals2351 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleVals2362 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_26_in_ruleVals2400 = new BitSet(new long[]{0x0000000000000090L});
    public static final BitSet FOLLOW_ruleIdent_in_ruleVals2422 = new BitSet(new long[]{0x0000000004000002L});
    public static final BitSet FOLLOW_ruleVals_in_ruleVals2450 = new BitSet(new long[]{0x0000000004000002L});
    public static final BitSet FOLLOW_ruleStepSuffix_in_entryRuleStepSuffix2498 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleStepSuffix2509 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_27_in_ruleStepSuffix2547 = new BitSet(new long[]{0x0000000000000090L});
    public static final BitSet FOLLOW_ruleSingleStep_in_ruleStepSuffix2569 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleImport_in_entryRuleImport2615 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleImport2626 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_28_in_ruleImport2664 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_RULE_STRING_in_ruleImport2679 = new BitSet(new long[]{0x0000000000000002L});
